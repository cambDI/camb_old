...
\author[Murrell \& Cortes-Ciriano \it{et~al}]{Daniel Murrell\,$^{1}$\footnote{Equal contributors} , Isidro Cortes-Ciriano\,$^{2,*}$, Gerard JP van Westen\,$^{3}$, Th\'er\`ese E. Malliavin\,$^{2,}$\footnote{to whom correspondence should be addressed} , Andreas Bender$^{1,}$\dag}
...
$^{3}$European Molecular Biology LaboratoryEuropean Bioinformatics Institute Wellcome Trust Genome Campus, Hinxton, United Kingdom.}
