...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,fig.align='center',fig.cap="Density of the response variable (left). Pairwise Compound Jaccard Similarity (right)",out.width='15cm'>>=
...
plotGrid(c("dens_resp","plot_pwd"),HeightBlocks=c(1),NCols=2,NRows=1)
@
