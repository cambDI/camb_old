...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),eval=TRUE>>=
...
dens_resp <- DensityResponse(bioactivity,xlab="pIC50",main="",ylab="Densitiy",TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24,AngleLab=0)
@
...
plot_pwd <- PairwiseDistPlot(pw_dist_comp_fps,xlab="Jaccard Similarity",ylab="Density",TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24)
...
<<out.extra='angle=90',highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,fig.align='center',fig.cap="Density of the response variable (left). Pairwise Compound Jaccard Similarity (right)",fig.width='5cm'>>=
grid_plot <- plotGrid(c("dens_resp","plot_pwd"),HeightBlocks=c(1),NCols=2,NRows=1)
grid_plot
@
...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,fig.align='center',fig.cap="Predicted vs Observed. The blue line corresponds to a margin of 2 pIC50 units.",out.width='12cm'>>=
ObsPred(pred=holdout.predictions,obs=dataset$y.holdout,PointSize=3,ColMargin='blue',TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24,margin=2,PointColor="black",PointShape=16,MarginWidth=1.5)
@
