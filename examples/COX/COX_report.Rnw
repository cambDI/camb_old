...
DensityResponse(bioactivity,xlab="pIC50",main="",ylab="Densitiy",TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24)
@
...
PCAProtPlot(target_PCA,PointSize=8,main="",TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24)
@
...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,fig.align='center',fig.cap="Pairwise Compound Jaccard Similarity",out.width='15cm'>>=
...
PairwiseDistPlot(pw_dist_comp_fps,xlab="Jaccard Similarity",ylab="Density",TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24)
@
...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,eval=FALSE>>=
MaxPerf(meanNoise=0,sdNoise=0.6,meanResp=mean(bioactivity),sdResp=sd(bioactivity),lenPred=800)
@
...
<<highlight=TRUE,tidy.opts=list(width.cutoff=50),tidy=TRUE,fig.align='center',fig.cap=TRUE,out.width='12cm'>>=
ObsPred(pred=holdout.predictions,obs=dataset$y.holdout,PointSize=3,ColMargin='green',TitleSize=26,XAxisSize=20,YAxisSize=20,TitleAxesSize=24,margin=1,PointColor="black",PointShape=16,MarginWidth=2)
@
