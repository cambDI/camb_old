...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: unused arguments (LegendTitleSize = 10, LegendTextSize = 10)}}\begin{alltt}
\hlstd{plot_PCA_Cox}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'plot\_PCA\_Cox' not found}}\end{kframe}
\end{knitrout}
...
\hlkwd{plotGrid}\hlstd{(}\hlkwd{c}\hlstd{(}\hlstr{"dens_resp"}\hlstd{,} \hlstr{"plot_pwd"}\hlstd{),} \hlkwc{HeightBlocks} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{),}
    \hlkwc{NCols} \hlstd{=} \hlnum{2}\hlstd{,} \hlkwc{NRows} \hlstd{=} \hlnum{1}\hlstd{)}
\end{alltt}


{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: unused arguments (HeightBlocks = c(1), NCols = 2, NRows = 1)}}\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=12cm]{figure/unnamed-chunk-32} 

}

\caption[Predicted vs Observed]{Predicted vs Observed. The blue line corresponds to a margin of 2 pIC50 units.\label{fig:unnamed-chunk-32}}
\end{figure}
