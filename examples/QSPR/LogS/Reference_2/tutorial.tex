...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'holdout.predictions' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: no applicable method for 'predict' applied to an object of class "{}randomForest"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'object' in selecting a method for function 'predict': Error: object 'nonlinear' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'x' in selecting a method for function 'sort': Error in is.data.frame(x) : object 'preds' not found\\\#\# Calls: colMeans -> is.data.frame}}\end{kframe}
\end{knitrout}
