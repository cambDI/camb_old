...
{\centering \includegraphics[width=8cm]{figure/unnamed-chunk-4} 

}

\caption[LogS Target Distribution]{LogS Target Distribution\label{fig:unnamed-chunk-4}}
\end{figure}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: could not find function "{}GetCVTrainControl"{}}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: could not find function "{}registerDoMC"{}}}\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=8cm]{figure/unnamed-chunk-16} 

}

\caption[CV RMSE over the hyperparameters]{CV RMSE over the hyperparameters\label{fig:unnamed-chunk-16}}
\end{figure}
